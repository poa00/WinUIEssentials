...
#include "MarqueeContainer.g.h"
#include <TemplateControlHelper.hpp>
#include <winrt/Windows.UI.Xaml.Media.Animation.h>

namespace winrt::UWPExample::implementation
{
    struct MarqueeContainer : MarqueeContainerT<MarqueeContainer>, TemplateControlHelper<MarqueeContainer>
    {
        MarqueeContainer() = default;
        ...
        UWPExample::MarqueeBehavior Behavior();
        void Behavior(UWPExample::MarqueeBehavior value);
        static winrt::Windows::UI::Xaml::DependencyProperty BehaviorProperty();

        UWPExample::MarqueeDirection Direction();
        void Direction(UWPExample::MarqueeDirection value);
    ...
    private:
        ...
        constexpr static auto MarqueeContainerPartName = L"MarqueeContainer";
...
{
    struct MarqueeContainer : MarqueeContainerT<MarqueeContainer, implementation::MarqueeContainer>
    {
    };
}
